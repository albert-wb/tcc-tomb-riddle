...
if (global.soma_next_room == 24) { // Se a soma global for menor igual a 25
	...
	var _proximaFase = instance_create_layer(3184, 240, "colisao", obj_next_room); // Cria uma nova instância do objeto obj_next_room na camada "colisao" nas coordenadas (736, 320)
