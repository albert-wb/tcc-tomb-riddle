	...
	if (is_transitioning) {
	    ...
	    if (fade_in) {
	        ...
	        if (fade_alpha <= 0) {
	            ...
	            if (current_cutscene > 6) { // Mudar para a próxima fase depois da última cutscene
					key_active = false;
					alarm[0] = 60;
	            } else {
	...
	if (is_transitioning) {
	    ...
	    if (fade_in) {
	        ...
	        if (fade_alpha <= 0) {
	            fade_alpha = 0; // Garantir que a opacidade não fique negativa
	            is_transitioning = false; // Finalizar a transição
	            if (current_cutscene > 14) { // Mudar para a próxima fase depois da última cutscene
					key_active = false;
					alarm[0] = 60;
	            } else {
	                fade_in = true; // Iniciar o fade in para a próxima cutscene
	...
	if (is_transitioning) {
	    ...
	    if (fade_in) {
	        ...
	        if (fade_alpha <= 0) {
	            fade_alpha = 0; // Garantir que a opacidade não fique negativa
	            is_transitioning = false; // Finalizar a transição
	            if (current_cutscene > 23) { // Mudar para a próxima fase depois da última cutscene
					key_active = false;
					alarm[0] = 60;
	            } else {
	                fade_in = true; // Iniciar o fade in para a próxima cutscene
